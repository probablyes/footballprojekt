...
import { getRecordList, deleteRecordCall } from '../../../apiCalls/wystepApiCalls';
...
class RecordList extends React.Component {
    ...
    render() {
        ...
        if (this.state.redirect === true) {
            redirectToForm = <Redirect to="/wystepy/form" />
        }
        ...
        const druzynyRows = this.state.druzyny.map((druzyna, index) => {
            return (
                <tr>
                    ...
                    <td>{druzyna.Id_p}</td>
                    <td>{druzyna.imie}</td>
                    <td>{druzyna.opis_wystepu}</td>
                    <td>{druzyna.minuty}</td>
                    <td><input type="radio" name="site_name" value={druzyna.Id_p}/>
                ...
                <table Id="table-generic" align="center">
                    ...
                    <tfoot>
                        <tr className="table-footer">
                            <td colSpan="5">
                                <button onClick={this.handleShowNewForm}>Nowy występ</button>
